...
CLIP_META = {
    ...
    # 2026-05-27 (水): 自動投稿再開バッチ 1日目 (2本)
    "29_GOMI_KURIPPER": {
        "title": "ゴミなクリッパーには金払わない #Shorts",
        "description": "革命一家ショウマ「ペイパービューに設定してる理由は ゴミなクリッパーに払わないため。 視聴回数あたりで成果報酬を支払うペイパービュー設計」\n#自分を見つける #ショウマ #革命一家 #クリッパー集団計画 #ペイパービュー",
        "tags": ["Shorts", "革命一家", "ショウマ", "コタカ", "クリッパー", "ペイパービュー", "成果報酬", "ゴミ"],
        "source_range_summary": "327-351 (ゴミなクリッパー + ペイパービュー定義)",
        "duration_s": 16.29,
        "not_before": "2026-05-27T22:00:00+09:00",
        "target_slot": "22:00",
    },
    "30_HIKARU_REIWA": {
        "title": "ヒカルや令和の虎を切り抜いてあげる #Shorts",
        "description": "革命一家ショウマ「巨人の戦い方ができる個人法人の認知をウイルスのように世界中にばらまく。 ヒカルや令和の虎のメンバーに切り抜いてあげる、 それがバックエンド商品」\n#自分を見つける #ショウマ #革命一家 #クリッパー集団計画 #ヒカル",
        "tags": ["Shorts", "革命一家", "ショウマ", "クリッパー", "ヒカル", "令和の虎", "バックエンド", "影響力"],
        "source_range_summary": "1003-1033 (バックエンド商品 = 有名人の切り抜き)",
        "duration_s": 17.87,
        "not_before": "2026-05-27T23:00:00+09:00",
        "target_slot": "23:00",
    },
}
